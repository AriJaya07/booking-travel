<div class="md:mx-[2em] mx-[1em] mb-[5em]">
    <div class="flex flex-col">
        <div id="loop-title">
            <!-- inner HTML -->
        </div>
        <div class="flex flex-col">
            <div id="loop-count-review" class="pt-5 pb-10 xl:px-[2em]">
                <!-- inner HTML -->
            </div>

            <div id="loop-review" class="flex flex-row flex-wrap gap-[2em] justify-center">
                <!-- inner HTML -->
            </div>
...
<script>
    function showReview(data) {
        ...
        function aboveReview() {
            ...
            loc +=
                `
				<h5 class="font-[700] md:text-[2em] text-[1.5em] pt-[3em]">
					What people are saying about ${d.about}, Indonesia
				</h5>
				`;
            top +=
                `
				<h5 class="font-[700] text-[1.5em] py-5">
					Overall rating
				</h5>
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                for (let p = startIndex; p < endIndex; p++) {
					...
					<div class="flex flex-col gap-[1em]">
						...
						<div class="lg:w-[34em] w-full flex flex-col">
							<p id="comment-review-${i}-${p}" class="flex flex-col">
								${d.people[p].comment}
							<p class="text-blue-500 py-5 font-[600]">
								${d.people[p].location}
							</p>
						</div>
					</div>
