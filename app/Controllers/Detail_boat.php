...
class Detail_boat extends BaseController
{
	public function index()
	{
		// Load the helper and view within the controller
		helper('url');
		return view("landing-page/detail-boat/detail-boat");
	}

	public function generateBoatActivity($id)
	{
		$items = [
			[
				'id' => 1,
				...
				"imageBanner" => [
					"https://cdn.getyourguide.com/img/tour/638873590ff72.png/98.jpg",
					"https://cdn.getyourguide.com/img/tour/63887355386a8.png/97.jpg",
					"https://cdn.getyourguide.com/img/tour/63887359961d9.png/53.jpg",
					"https://cdn.getyourguide.com/img/tour/63887356ea750.png/53.jpg",
				],
	...
	public function generateReviewBoat($id)
	{
		$items = [
			[
				'id' => 1,
